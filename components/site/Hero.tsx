  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 flex flex-col justify-center pt-4 pb-12 sm:pb-16 md:pb-20 w-full max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        {/* Heading */}
        <div className="w-full mt-0 sm:mt-2 md:mt-4 mb-8 sm:mb-12 px-4 sm:px-0 flex flex-col items-center">
          ...
          {/* Subheading */}
          <p
            className="mt-3 sm:mt-4 text-center text-[13px] sm:text-[14px] md:text-[16px] text-[#F4F4F0]/85 tracking-[0.06em] leading-relaxed max-w-[280px] sm:max-w-[420px] md:max-w-[500px] mx-auto font-light animate-fadeUp opacity-0"
